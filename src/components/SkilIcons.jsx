...
const Flutter = ({ width = 40, height = 45 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <g fill="none">
          <path
            fill="#02569B"
            d="M28.83 190.06l92.85-92.8 92.8 92.8-41.55 41.55-51.2-51.25-51.25 51.25z"
          />
          <path
            fill="#0175C2"
            d="M164.13 231.61l-41.55 41.55-92.85-92.85 51.25-51.2z"
          />
          <path
            fill="#33BDF8"
            d="M186.95 167.51l-92.8-92.8 92.8-92.8 41.55 41.55-51.2 51.2 51.2 51.2z"
          />
        </g>
      </svg>
    </>
